...
- TypeScript;
- Tailwind CSS 4;
- Motion для переходов интерактивной галереи;
- shadcn/ui и Base UI для доступного Accordion;
...
Для вкладок возможностей используются 20 состояний: пять типов контента по четыре сценария. Изображения плавно меняются вручную или автоматически через 10 секунд. FAQ реализован на доступном Accordion из shadcn/ui.
...
При дополнительном времени можно добавить анимации появления секций, более глубокую оптимизацию изображений и автоматические визуальные regression-тесты для основных разрешений.
